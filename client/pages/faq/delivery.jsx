      ...
      <Layout>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <ol>
            ...
            <li>
              Pengiriman barang ke Expedisi 1 hari kerja setelah pembayaran
            </li>
            ...
            <li>
              Proses Pengembalian dana hingga dana ditransfer kembali ke
              rekening pembeli
            </li>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <ol>
            ...
            <li>
              {' '}
              Setelah barang siap , pembeli akan mendapat pemberitahuan dari
              Admin kami melalui Whatssapp / Telp
            </li>
            <li>
              {' '}
